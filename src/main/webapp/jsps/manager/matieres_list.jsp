					...
					<div class="card">
						<div class="card-body">
							...
							<button type="button"
								...
								<i class="fa-solid fa-book me-2"></i> <span class="fw-bold">Nouvelle Matière</span>
								...
								<div class="modal-dialog modal-lg modal-dialog-centered">
									<div class="modal-content">
										<div class="modal-header">
											<h4 class="modal-title" id="exampleModalLabel">Nouvelle Matière</h4>
							...
							<h5 class="card-title text-center fs-3">Tableau des Matières</h5>
